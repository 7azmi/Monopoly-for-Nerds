        ...
        public class Chest : Place
        {
            ...
            public override void Land()
            {
                ...
                void PayDoctorFees(Player player)
                {
                    ...
                    Human.Terminal.Log($"$50 Doctor fees");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(100);
                    Human.Terminal.Log($"Collect $50 Holiday Fund Matures");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.SpendMoney(50);
                    Human.Terminal.Log($"Pay $50 school fees");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                void HospitalFees(Player player)
                {
                    ...
                    Human.Terminal.Log($"Pay $100 hospital fees");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(25);
                    Human.Terminal.Log($"recieve $25 consultancy fee");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(100);
                    Human.Terminal.Log($"You inherit $100 from your grandma");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(50);
                    Human.Terminal.Log($"Collect $50 from the stock market");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(10);
                    Human.Terminal.Log($"Collect $10 as a prize for some reason");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
                ...
                {
                    player.AddMoney(200);
                    Human.Terminal.Log($"Bank error in your favor. Collect $200");
                    Engine.OnLandingCompleted?.Invoke(this);
                }
            }
        }
